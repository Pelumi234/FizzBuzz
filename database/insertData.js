...
pool.query(
    `INSERT INTO TeamOluwapelumiAlake2021 
                 (ID, NAME, AGE, DEPARTMENT, ROLE, STATUS, CREATEED_DT)
                 VALUES 
                 ('1', 'Sarah', '5', 'Accounting', 'PM' , 'Activated', '01-01-2021'),
                 ('2', 'Tim', '10', 'Engineering', 'QA' , 'Pending', '02-01-2021'),
                 ('3', 'Joe', '17', 'Management', 'PM' , 'Activated', '02-01-2021'),
                 ('4', 'Tolu', '25', 'Management', 'Dev' , 'Pending', '02-01-2021'),
                 ('5', 'Rob', '5', 'Engineering', 'QA' , 'Activated', '03-01-2021'),
                 ('6', 'Ade', '10', 'Management', 'QA' , 'Pending', '04-01-2021'),
                 ('7', 'Tom', '17', 'Security', 'QA' , 'Activated', '05-01-2021'),
                 ('8', 'Jide', '26', 'Accounting', 'Dev' , 'Activated', '06-01-2021')
                 `,
    (err, res) => {
      if(err) {
          console.log(err)
